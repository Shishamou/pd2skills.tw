...
/***/ function(module, exports, __webpack_require__) {
	...
	var _skills = __webpack_require__(198);

	var _skills2 = _interopRequireDefault(_skills);

	var _skills3 = __webpack_require__(188);
	...
	var store = createStoreWithMiddleware(_skills2.default);

	store.dispatch((0, _skills3.fetchSkills)('public/skills.json'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Provider = __webpack_require__(179);
	var connect = __webpack_require__(181);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var storeShape = __webpack_require__(180);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isPlainObject = __webpack_require__(183);
	var wrapActionCreators = __webpack_require__(184);
	var hoistStatics = __webpack_require__(185);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Trees = __webpack_require__(192);
	...
	var App = (function (_Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            ...
	            var tiers = _props.tiers;
	            var skills = _props.skills;

	            return _react2.default.createElement(_Trees2.default, {
	                trees: trees,
	                ...
	                handleEvent: function handleEvent(id, event) {
	                    return dispatch((0, _skills.handleSkillEvent)(id, event));
	                }
	            });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.handleSkillEvent = handleSkillEvent;
	...
	var _SkillActionTypes = __webpack_require__(191);

	var types = _interopRequireWildcard(_SkillActionTypes);

	function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	function addSkill(model) {
	    return { type: types.ADD_SKILL, model: model };
	}

	function handleSkillEvent(id, event) {
	    return { type: types.HANDLE_SKILL_EVENT, id: id, event: event };
	}

	function fetchSkills(uri) {
	    return function (dispatch) {
	        dispatch(fetchSkillsRequest());
	        return (0, _isomorphicFetch2.default)(uri).then(function (response) {
	...
	function fetchSkillsSuccess(response) {
	    return { type: types.FETCH_SKILLS, status: 'success', response: response };
	}

	function fetchSkillsError(error) {
	    return { type: types.FETCH_SKILLS, status: 'error', error: error };
	}
...
/***/ function(module, exports) {
	...
	var FETCH_SKILLS = exports.FETCH_SKILLS = 'FETCH_SKILLS';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Trees = (function (_Component) {
	    ...
	    function Trees() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Trees).apply(this, arguments));
	    }
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                trees.map(function (tree, index) {
	                    return _react2.default.createElement(_Tree2.default, _extends({}, _this2.props, {
	                        key: index,
	                        id: index,
	                        tree: tree
	                    }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Tier = __webpack_require__(194);
		...
		_createClass(Tree, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					{ className: 'tree' },
					tiers.map(function (tierId, index) {
						return _react2.default.createElement(_Tier2.default, _extends({}, _this2.props, {
							key: index,
							id: tierId
						}));
					})
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Skill = __webpack_require__(195);
	...
	var Tier = (function (_Component) {
		...
		_createClass(Tier, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					{ className: 'tier', 'data-unlock': tier.unlocked },
					_react2.default.createElement(
						'div',
						{ className: 'tier-skills' },
						tier.skills.map(function (skillId, index) {
							return _react2.default.createElement(_Skill2.default, _extends({}, _this2.props, {
								key: index,
								id: skillId,
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'p',
							null,
							tier.currectUnlockNeeded
						),
						_react2.default.createElement(
							'p',
							null,
							tier.currectUnlockRequire
						)
					)
				);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SkillStatuses = __webpack_require__(196);
	...
	var Skill = (function (_Component) {
		...
		_createClass(Skill, [{
			...
			key: 'render',
			value: function render() {
				var _statuses$STATUS_ALER,
				    _this2 = this;

				var _props = this.props;
				var id = _props.id;
				var getSkill = _props.getSkill;
				var skillPointBasic = _props.skillPointBasic;
				var skillPointAce = _props.skillPointAce;

				var skill = getSkill(id);

				var dataset = skill.status.split('_').slice(-1).pop().toLowerCase();
				var content = (_statuses$STATUS_ALER = {}, _defineProperty(_statuses$STATUS_ALER, statuses.STATUS_ALERTED, _react2.default.createElement(
					'p',
					null,
					'必要'
				)), _defineProperty(_statuses$STATUS_ALER, statuses.STATUS_ACED, _react2.default.createElement(
					'p',
					null,
					'王牌'
				)), _defineProperty(_statuses$STATUS_ALER, statuses.STATUS_OWNED, _react2.default.createElement(
					'div',
				...
				)), _defineProperty(_statuses$STATUS_ALER, statuses.STATUS_UNLOCKED, _react2.default.createElement(
					'div',
					{ className: 'text-group' },
					_react2.default.createElement(
						'p',
				...
				)), _defineProperty(_statuses$STATUS_ALER, statuses.STATUS_LOCKED, _react2.default.createElement(
					'div',
					{ className: 'text-group' },
					_react2.default.createElement(
						'p',
				...
				)), _statuses$STATUS_ALER)[skill.status];
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement('div', { className: 'skill-icon' }),
					_react2.default.createElement(
						'div',
	...
	Skill.propTypes = {
		...
		getTier: _react.PropTypes.func.isRequired,
		getSkill: _react.PropTypes.func.isRequired,
		skillPointBasic: _react.PropTypes.number.isRequired,
		skillPointAce: _react.PropTypes.number,
		handleEvent: _react.PropTypes.func.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxReducerSwitcher = __webpack_require__(199);

	var _SkillActionTypes = __webpack_require__(191);

	var types = _interopRequireWildcard(_SkillActionTypes);

	var _handleSkillEvent = __webpack_require__(200);

	var _handleSkillEvent2 = _interopRequireDefault(_handleSkillEvent);

	var _fetchSkills = __webpack_require__(201);

	var _fetchSkills2 = _interopRequireDefault(_fetchSkills);
	...
	var Skills = (function () {
	    ...
	    _createClass(Skills, [{
	        ...
	        value: function switcher() {
	            ...
	            return _ref = {}, _defineProperty(_ref, types.ADD_SKILL, this.addSkill), _defineProperty(_ref, types.HANDLE_SKILL_EVENT, function (state, action) {
	                return (0, _handleSkillEvent2.default)(action.event)(state, action);
	            }), _defineProperty(_ref, types.FETCH_SKILLS, function (state, action) {
	                return (0, _fetchSkills2.default)(action.status)(state, action);
	            }), _ref;
	        }
	    }]);
	...
	exports.default = (0, _reduxReducerSwitcher.buildReducer)(Skills, {
	    trees: [],
	    tiers: [],
	    skills: []
	});
...
/***/ function(module, exports) {
	...
	exports.buildSwitcher = buildSwitcher;

	function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }

	function buildReducer(scaffolding) {
	    var initialState = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];

	    var switcher = buildSwitcher(scaffolding).setDefault(function (state) {
	        return state;
	    });
	    return function (state, action) {
	        state = typeof state === 'undefined' ? initialState : Object.assign({}, state);
	        return switcher.resolve(action.type)(state, action);
	    };
	}

	function buildSwitcher(scaffolding) {
	    var _this = this;
	    ...
	    var addHookBefore = function addHookBefore(callable) {
	        if (isCallable(callable)) hookBefore.push(callable);
	        return _this;
	    };

	    var addHookAfter = function addHookAfter(callable) {
	    ...
	    var instance = new scaffolding({ addHookBefore: addHookBefore, addHookAfter: addHookAfter });
	    var cases = (function (instance) {
	        if (!isCallable(instance.switcher)) throw "Method switcher not defined.";
	        var cases = instance.switcher();

	        if (!(cases instanceof Object)) throw "Method switcher must return an object.";
	        return cases;
	    })(instance);
	    ...
	    function resolve(flag) {
	        var command = cases[flag] || defaultCommand;
	        return function () {
	            for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	                args[_key] = arguments[_key];
	            }

	            return Array().concat(hookBefore, command, hookAfter).reduce(function (previous, currectHandler, index) {
	                previous = previous || [];
	                previous = !(previous instanceof Array) ? [previous] : previous;
	                try {
	                    return currectHandler.bind(instance).apply(undefined, _toConsumableArray(previous));
	                } catch (error) {
	                    console.log({ error: error, previous: previous, currectHandler: currectHandler, index: index });
	                }
	            }, args);
	        };
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SkillEvents = (function () {
	    // =========================================================================
	    // = Switcher
	    // =========================================================================

	    function SkillEvents(hooks) {
	        var _this = this;

	        _classCallCheck(this, SkillEvents);

	        // 取出要處理的 Skill 並傳入
	        hooks.addHookBefore(function (state, action) {
	            _this.state = state;
	            return _this.currectSkill = _this.getSkill(action.id);
	        });

	        // 更新技能樹
	        hooks.addHookAfter(function () {
	            _this.updateTreeState(_this.currectSkill.treeId);
	            _this.refreshSkillsStatus();
	            return _this.state;
	        });

	        // 複製刷新 State
	        hooks.addHookAfter(function (state) {
	    ...
	    _createClass(SkillEvents, [{
	        key: 'switcher',
	        value: function switcher() {
	            var _ref;

	            return _ref = {}, _defineProperty(_ref, events.CLICK, this.handleClick), _defineProperty(_ref, events.MOUSE_ENTER, this.handleMouseEnter), _defineProperty(_ref, events.MOUSE_LEAVE, this.handleMouseLeave), _defineProperty(_ref, events.REMOVE, this.handleRemove), _ref;
	        }
	    }, {
	        key: 'handleClick',
	        value: function handleClick(skill) {
	            if (!skill.ownedBasic) {
	        ...
	        key: 'handleMouse',
	        value: function handleMouse(skill) {
	            var hover = arguments.length <= 1 || arguments[1] === undefined ? true : arguments[1];
	        ...
	        key: 'handleMouseEnter',
	        value: function handleMouseEnter(skill) {
	            this.handleMouse(skill, true);
	        }
	    }, {
	        key: 'handleMouseLeave',
	        value: function handleMouseLeave(skill) {
	            this.handleMouse(skill, false);
	        }
	    }, {
	        key: 'handleRemove',
	        value: function handleRemove(skill) {
	        ...
	        key: 'updateTreeState',
	        value: function updateTreeState(tree) {
	            var _this2 = this;
	            ...
	            tree.tiers.forEach(function (tier) {
	                tier = _this2.getTier(tier);
	                _this2.updateTreeStateHandleTier(tier, tree);
	            }, this);
	        }
	    }, {
	        key: 'updateTreeStateHandleTier',
	        value: function updateTreeStateHandleTier(tier, tree) {
	            var _this3 = this;
	            ...
	            tier.skills.forEach(function (skill) {
	                skill = _this3.getSkill(skill);
	                _this3.updateTreeStateHandleSkill(skill, tier, tree);
	            }, this);
	        }
	    }, {
	        key: 'updateTreeStateHandleSkill',
	        value: function updateTreeStateHandleSkill(skill, tier, tree) {
	        ...
	        key: 'updateTreeStateHandleSkillUpdate',
	        value: function updateTreeStateHandleSkillUpdate(skill, tier, tree) {
	            // 檢查階層解鎖
	            ...
	            skill.unlockedAce = tier.skillPointAce >= 0 ? skill.ownedBasic ? skill.ownedAce || availablePoint >= tier.skillPointAce : availablePoint >= tier.skillPointBasic + tier.skillPointAce : false;
	        }
	    }, {
	        key: 'refreshSkillsStatus',
	        value: function refreshSkillsStatus() {
	        ...
	        key: 'getSkillByName',
	        value: function getSkillByName(searchingName, throwError) {
	...
	exports.default = (0, _reduxReducerSwitcher.buildSwitcher)(SkillEvents).resolve;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SkillsBuilder = __webpack_require__(202);
	...
	var FetchSkills = (function () {
	    function FetchSkills() {
	        _classCallCheck(this, FetchSkills);
	    }

	    _createClass(FetchSkills, [{
	        key: 'switcher',
	        value: function switcher() {
	            return {
	        ...
	        key: 'onSuccess',
	        value: function onSuccess(state, action) {
	            try {
	                new _SkillsBuilder2.default(state).build(action.response);
	            } catch (e) {
	                console.log(e);
	            }
	            return state;
	        ...
	        key: 'onError',
	        value: function onError(state, action) {
	            console.log('Fetch skills failed: ' + action.error);
	            return state;
	        }
	    }, {
	        key: 'default',
	        value: function _default(state, action) {
	            state.tiers = [];
	            state.skills = [];
	            return state;
	        }
	...
	exports.default = (0, _reduxReducerSwitcher.buildSwitcher)(FetchSkills).resolve;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SkillsBuilder = (function () {
	    ...
	    _createClass(SkillsBuilder, [{
	        ...
	        key: 'build',
	        value: function build(skillsModel) {
	            var _this = this;
	            ...
	            trees.forEach(function (tree) {
	                return _this.buildTree(tree, tierSettings);
	            });
	        }
	        ...
	        key: 'buildTree',
	        value: function buildTree(treeModel, tierSettings) {
	            var _this2 = this;

	            var tree = this.parseTreeModel(treeModel);
	            var treeId = this.registerTree(tree);

	            tree.tiers = treeModel['skills'].map(function (skills, tierIndex) {
	                return _this2.buildTier(Object.assign({ treeId: treeId, skills: skills }, tierSettings[tierIndex]));
	            }, this);
	        }
	        ...
	        key: 'buildTier',
	        value: function buildTier(tierModel) {
	            var _this3 = this;
	            ...
	            tier.skills = tierModel.skills.map(function (skill) {
	                return _this3.buildSkill(Object.assign({ treeId: treeId, tierId: tierId }, skill));
	            }, this);
	        ...
	        key: 'buildSkill',
	        value: function buildSkill(skillModel) {
	        ...
	        key: 'modelAttributeToCamelCase',
	        value: function modelAttributeToCamelCase(model) {
	            var _this4 = this;
	            ...
	            if (Array.isArray(model)) {
	                return model.map(function (value) {
	                    return _this4.modelAttributeToCamelCase(value);
	                }, this);
	            }
	            ...
	            Object.keys(model).forEach(function (key) {
	                var value = model[key];
	                value = _this4.modelAttributeToCamelCase(value);

	                key = _this4.toCamelCase(key);
	                handled[key] = value;
	            }, this);
	        ...
	        key: 'parseTreeModel',
	        value: function parseTreeModel(model) {
	            var name = model.name;
	            return {
	                name: model.name,
	        ...
	        key: 'parseTierModel',
	        value: function parseTierModel(model) {
	            return {
	                treeId: model.treeId,
	        ...
	        key: 'parseSkillModel',
	        value: function parseSkillModel(model) {
	            var name = model.name;
	            return {
	                treeId: model.treeId,
	                tierId: model.tierId,
